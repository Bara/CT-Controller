...
#define CNAME "CT_Verify"
#define SOUND "buttons/button11.wav"
#define LoopClients(%1) for(int %1 = 1; %1 <= MaxClients; %1++) if(IsClientValid(%1))
#define MSG_BAN "{\"attachments\": [{\"color\": \"{COLOR}\",\"fields\":[{\"title\": \"Map\",\"value\": \"{MAP}\",\"short\": true},{\"title\": \"Tick\",\"value\": \"{TICK}\",\"short\": true},{\"title\": \"Player\",\"value\": \"{NICKNAME} ( {STEAMID} )\",\"short\": true},{\"title\": \"Admin\",\"value\": \"{ADMIN}\",\"short\": true},{\"title\": \"Ban Length\",\"value\": \"{BANLENGTH}\",\"short\": true},{\"title\": \"Reason\",\"value\": \"{REASON}\",\"short\": true}]}]}"
...
{
	g_cTime = CreateConVar("ct_controller_menu_time", "10", "Time in seconds to show a menu");
	g_cStammPoints = CreateConVar("ct_controller_stamm_points", "500", "Stamm points for ct (if player not verifiered)");
	g_cWebhook = CreateConVar("ct_controller_discord_webhook", "ctbans", "Config key from configs/discord.cfg.");
	g_cColor = CreateConVar("ct_controller_discord_color", "#ff6347", "Discord/Slack attachment color.");
	...
	CSetPrefix("{darkblue}[CT-Controller]{default}");
}
